...
TRAIN_PATH = os.path.join(MASKS_PATHS, 'Part_B_train_coco_annotations.json')
...
cfg.backbone.path = os.path.join(DATA_FOLDER,'phhale/ford/experiments/yolact/yolact_pretrained_models/resnet50-19c8e357.pth') 
